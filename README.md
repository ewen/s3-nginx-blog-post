...
This is a simple application showing a pattern for using NGINX's X-Accel with remote URLs. See the blog post at https://madecurious.com/articles/using-nginxs-x-accel-with-remote-urls/.
